...
aws s3 mb s3://quarkus.s3.quickstart --endpoint-url=http://localhost:4566
...
`docker run --rm --network=localstack --name localstack -p 4572:4572 -e SERVICES=s3 -e START_WEB=0 -d localstack/localstack`
